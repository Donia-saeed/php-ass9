        ...
        <?php foreach ($products as $product): ?>
          <tr>
            ...
            <td>
              ...
              <!-- Button to delete product (trigger confirmation dialog) -->
              <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal<?php echo $product['id']; ?>">Delete</button>
